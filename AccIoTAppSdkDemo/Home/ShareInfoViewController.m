...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"Share Information";
    self.view.backgroundColor = [UIColor whiteColor];
    
    UIButton *shareButton = [UIButton buttonWithType:UIButtonTypeCustom];
    [shareButton setTitle:@"Get Share Code" forState:UIControlStateNormal];
    ...
    ptomptLabel.text = @"Manage Share Permissions";
...
- (void)tapShareCode {
    ...
    [self.view makeToast:@"Copied" duration:3 position:CSToastPositionCenter];
}
