...
- (void)viewDidLoad {
    ...
    self.title = @"Modify Phone Number";
    ...
    self.oldPhoneTextField.placeholder = @"Please enter the current phone number";
    ...
    self.oldSmsTextField.placeholder = @"Please enter the verification code for the current phone number";
    ...
    [oldSmsButton setTitle:@"Get Verification Code" forState:UIControlStateNormal];
    ...
    self.phoneTextField.placeholder = @"Please enter the new phone number";
    ...
    self.smsTextField.placeholder = @"Please enter the verification code for the new phone number";
...
- (void)sureButtonClick {
    ...
    [[QuecUserService sharedInstance] updatePhone:self.phoneTextField.text newInternationalCode:@"86" newPhoneCode:self.smsTextField.text oldPhone:self.oldPhoneTextField.text oldInternationalCode:@"86" oldPhoneCode:self.oldSmsTextField.text success:^{
        [MBProgressHUD hideHUDForView:self.view animated:YES];
        [self.view makeToast:@"Phone number modification successful" duration:3 position:CSToastPositionCenter];
        } failure:^(NSError *error) {
            [MBProgressHUD hideHUDForView:self.view animated:YES];
            [self.view makeToast:error.localizedDescription duration:3 position:CSToastPositionCenter];
        }];
